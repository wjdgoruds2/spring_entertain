					...
					<div class="card-body p-4">
						...
						<div class="row">
							...
							<div class="col-lg-4">
								...
								<div class="media mb-3">
									<c:forEach var="row" items="${list }">
										<input type="hidden" id=BOARD_TITLE
											value="${row.BOARD_TITLE }">
							...
							<div class="col-lg-8">
								...
								<br> <br>
								<button type="button"
									class="btn btn-primary btn-lg btn-block mb-lg-0 mb-5">
									<a style="color: white; text-align: right"
										href='<c:url value='/board/boardReservation?title=${map.TITLE }'/>'>예약하기</a>
								</button>
								<button type="button" class="btn btn-secondary btn-lg"
									style="float: right;">
									<a style="color: white; text-align: right"
										href='<c:url value='/board/boardList'/>'>목록으로</a>
								</button>
								<button type="button" class="btn btn-info btn-lg"
									style="float: right;">
									<a style="color: white; text-align: right"
										href='<c:url value='/board/boardReplydetail?title=${map.TITLE }'/>'>댓글보기</a>
								</button>
								<br> <br>
	...
	<form method="post" action="${insertUrl}">
		...
		<table style="text-align: center"
			...
			<tr>
				...
				<td colspan='3' style="text-align: left">${map.TITLE }</td>
			</tr>
			...
			<tr>
				...
				<td colspan='3' style="text-align: left"><input type="text"
					name="subject" cols="90" placeholder="제목을 입력하세요"></td>

			</tr>
			<tr>
				<th class="table-danger">작성자</th>
				<td style="text-align: left">${authInfo.id }</td>
				<th></th>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td colspan='2' style="text-align: left"><textarea
						name="content" cols="90" rows="5" placeholder="내용을 입력하세요"></textarea></td>
				<td style="vertical-align: bottom">
					<button type="submit" class="btn btn-info">등록하기</button>
					<button type="button" class="btn btn-secondary">
						<a href='<c:url value='/board/boardList'/>' style="color: white"
							role="button">목록으로</a>
					</button>
