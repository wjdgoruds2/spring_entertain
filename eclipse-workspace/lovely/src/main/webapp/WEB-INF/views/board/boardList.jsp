				...
				<ul class="navbar-nav mr-auto">
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href='/board/myreservationList?id=${authInfo.id }'> 나의 예약 정보</a> <a class="dropdown-item"
								...
								<div class="nav navbar-nav"
									...
									<div class="active">
										<a href="/board/boardList" style="text-decoration: none"><span
											class="glyphicon glyphicon-plane"></span> <font color="white">공연
												전체 보기 </font> </a>
										<hr>
									</div>
...
<%-- 										<div class="col-lg-5">
											...
											<c:when test=${bList.TITLE eq row.BOARD_TITLE}">
      <img width="300" height="400" src="/resources/boardimage/${row.STORED_FILE_NAME }" >
											...
											<img class="img-fluid rounded" src="./img/${article.imgpath}"
												alt="" style="width: 100%; height: 50%">
										</div> --%>
										<div class="col-lg-12">
											<h3>${bList.TITLE }</h3>
											<ul>
